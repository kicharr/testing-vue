<template>
  <div class="wrapper">
    ...
    <div class="lesson lesson-5">
      ...
      <hr>
      <p>Ширина: <a-input type="number" v-model:value="width" placeholder="Ввидите ширину"/></p>
      <p>Высота: <a-input type="number" v-model:value="height" placeholder="Ввидите высоту"/></p>
